...
urlpatterns = patterns('',
    ...
    # Classification:
    url(r'^statistics/classificationmonth_json/(?P<pk>\d+)/(?P<year>\d+)/(?P<month>\d+)/$',
        views.StatisticsClassificationMonth_json,
        name='StatisticsClassificationMonth_json'),
    url(r'^statistics/classification/main/(?P<pk>\d+)/$',
        views.StatisticsClassification,
        name='StatisticsClassification'),
    url(r'^statistics/classification/month/(?P<pk>\d+)\/(?P<year>\d+)/(?P<month>\d+)/$',
        views.StatisticsClassification,
        name='StatisticsClassificationMonth'),
    # Car:
    url(r'^statistics/car_json/(?P<pk>\d+)/(?P<year>\d+)/$',
        views.StatisticsCar_json,
        name='StatisticsCar_json'),
    url(r'^statistics/car/(?P<pk>\d+)/(?P<year>\d+)/$',
        views.StatisticsCar,
        name='StatisticsCar'),
