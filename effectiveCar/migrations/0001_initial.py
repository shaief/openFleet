...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'effectiveCar_parking', (
            ...
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 3, 5, 0, 0))),
            ('cost', self.gf('django.db.models.fields.FloatField')()),
        ))
        ...
        # Adding model 'Accidents'
        db.create_table(u'effectiveCar_accidents', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('license_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['effectiveCar.Car'])),
        ...
        db.send_create_signal(u'effectiveCar', ['Accidents'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Accidents'
        db.delete_table(u'effectiveCar_accidents')


    models = {
        u'effectiveCar.accidents': {
            'Meta': {'object_name': 'Accidents'},
            'cost': ('django.db.models.fields.FloatField', [], {}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 5, 0, 0)'}),
