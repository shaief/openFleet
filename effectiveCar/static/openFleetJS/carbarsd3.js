...
.orient("left")
    ...
    d3.json(car, function(error, json) {
      var data = json;
      console.log(data);
    ...
    // var sortByDate = function(a, b) { return b.id - a.id; };
    var sortByDate = function(a, b) { return d3.ascending(a.id, b.id); };
    var sortedItems = data.sort(this.checked ? sortByMax : sortByDate)
    .map(function(d) { return d.id; })
    x.domain(sortedItems)
