...
var kmTip = d3.tip()
  ...
  .offset([-10, 0])
  .html(function(d) {
    return ("<strong>License ID:</strong> <span style='color:blue'>" + d.car + "</span><br><strong>km per month:</strong> <span style='color:red'>" + d.km_per_month + "</span>");
  })

var kmSvg = d3.select("#kmchart").append("svg")
...
d3.json(classification, function(error, json) {
  ...
  kmSvg.selectAll(".bar")
    ...
    .append("rect")
      ...
      .on('mouseover', kmTip.show)
      .on('mouseout', kmTip.hide)
...
d3.select('input').on('change', function() {
    ...
    var transition = kmSvg.transition().duration(750);
